...
import { MIDLEVEL_DEVELOPER, STAFF_USER, JOB_ROLES } from "../../utility/types";
...
export const AddStaff = () => {
    ...
    const {
        ...
        callback: createUser,
    } = useAPI(addUser, Object.values(userDetails), true);
    ...
    }, [createDirectReport, createUserData, createUserError, navigate, setShowToast]);
